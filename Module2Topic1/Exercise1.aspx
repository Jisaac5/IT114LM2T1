...
<body>
    ...
    <form runat="server">
        ...
        <asp:Label runat="server">Radiohead - Bodysnatchers</asp:Label>
        <br />
        ...
        <asp:Image runat="server" ImageUrl="in rainbows.jpg" Height="200" Width="200" AlternateText="Radiohead In Rainbows Album Art"/>
        <br />
        ...
        <asp:Button runat="server"  Text="Play" OnClick="PlayClick" /> 
        <asp:Button runat="server"  Text="Next" /> <br />
        ...
        <span runat="server" id="nowPlaying"></span> <br />
